...
$sql = "UPDATE intrebari SET Status=:status WHERE  id=:id";
...
<html>
<head>
<title>Vizualizare intrebari</title>
...
{				?>		
						  <tr>
							...
							<td width="50"><?php echo htmlentities($result->username);?></td>
								<td width="50"><?php echo htmlentities($result->mobile);?> /<br />
